...
$ques_easy_rand=array();
$ques_easy=ceil($tot_ques*($ques_easy_per/100));
$ques_easy_rand=array_rand($ques_easy_list,$ques_easy);
...
$ques_medium_rand=array();
$ques_medium=ceil($tot_ques*($ques_medium_per/100));
$ques_medium_rand=array_rand($ques_medium_list,$ques_medium);
//echo sizeof("medium".$ques_medium_list);
...
$ques_hard_rand=array();
$ques_hard=$tot_ques-($ques_easy+$ques_medium);
$ques_hard_rand=array_rand($ques_hard_list,$ques_hard);
//echo sizeof("hard".$ques_hard_list);*/

//echo sizeof("Total".$queslist);
$queslist=array();
            ...
            if ($qno == "1")
            {
                ...
                print '
											<div role="tabpanel" class="tab-pane active fade in" id="tab' . $qno . '">
                                             ...
                                             <input type="hidden" name="typ' . $qno . '" value="' . base64_encode($etyp) . '">
                                             </div>
											';
            }
            else
...
if (sizeof($queslist) > 0)//$result->num_rows > 0)
{
    ...
    for ($x = 0; $x<sizeof($queslist); $x++)
    {
        ...
        if ($qno == "1")
        {
            print '<li style="background-color:'.$ques_style.';" role="presentation" class="active"><a href="#tab' . $qno . '" role="tab" data-toggle="tab">' . $qno . '</a></li>';
        }
        else
        {
            print '<li style="background-color:'.$ques_style.';"role="presentation"><a href="#tab' . $qno . '" role="tab" data-toggle="tab">' . $qno . '</a></li>';
        }
