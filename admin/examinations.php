												...
												<div role="tabpanel" class="tab-pane fade" id="tab6">
														...
														<form action="pages/add_exam.php" method="POST">
															...
															<div class="form-group">
																...
																<input type="number" class="form-control" placeholder="Enter Total questions" name="tot_ques" required autocomplete="off"> </div>
															<div class="form-group">
																<label for="exampleInputEmail1">No: of Easy questions in %</label>
																<input type="number"  min="0" max="100" step="5" id ="easy" class="category form-control" placeholder="Enter number of questions in %" name="ques_easy" required autocomplete="off" onchange="handleChange(this);"> </div>
															<div class="form-group">
																<label for="exampleInputEmail1">No: of Medium questions in %</label>
																<input type="number"  min="0" max="100" step="5" id ="medium"class="category form-control" placeholder="Enter number of questions in %" name="ques_medium" required autocomplete="off" onchange="handleChange(this);"> </div>
															<div class="form-group">
																<label for="exampleInputEmail1">No: of Hard questions in %</label>
																<input type="number" min="0" max="100" step="5"id ="hard" class="category form-control" placeholder="Enter number of questions in %" name="ques_hard" required autocomplete="off" onchange="handleChange(this);"> </div>
															<div class="form-group">
